...
<head>
    ...
    <!-- Title Page-->
    <title>Admin | INFORMATIKA UPGRIS</title>
    <link rel="shortcut icon" href="../assets/img/sae-icon.png">
    ...
    <link href="<?php echo base_url(); ?>assets/admin/css/w3.css" rel="stylesheet" media="all">

    <!-- Data Tables CSS-->
    <link href="<?php echo base_url(); ?>assets/admin/datatables/datatables.min.css" rel="stylesheet" media="all">
    <link href="<?php echo base_url(); ?>assets/admin/datatables/css/dataTables.bootstrap4.min.css" rel="stylesheet" media="all">    
    <link href="<?php echo base_url(); ?>assets/admin/datatables/DataTables-1.10.21/css/dataTables.bootstrap4.min.css" rel="stylesheet" media="all">
</head>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button type="button" class="btn btn-secondary mb-1" data-toggle="modal" data-target="#bulananModal">
                                        Bulanan
                                </button>
                                <button type="button" class="btn btn-secondary mb-1" data-toggle="modal" data-target="#harianModal">
                                        Harian
                                </button>
                                    </div>
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i>cetak</button>
                                    </div>
                                </div>
